/**
 * INJEÇÃO COMPLETA WEBFLOW - IMEDIATO SEGUROS V6.4.2
...
(function() {
    ...
    class ProgressModalRPA {
        ...
        startProgressPolling() {
            ...
            this.pollCount = 0;
            this.maxPolls = 30; // 30 tentativas = 60 segundos (2s cada)
            ...
            this.progressInterval = setInterval(() => {
                ...
                if (this.pollCount > this.maxPolls) {
                    console.error('❌ Timeout: Demora excessiva no processamento');
                    this.stopProgressPolling();
                    this.showErrorAlert('Demora excessiva no processamento. Tente novamente.');
                    return;
                }
        ...
        updateResults(data) {
            ...
            if (resultados) {
                ...
                if (valorRecomendado) {
                    const recommendedValue = document.querySelector('#rpaModal #recommendedValue');
                    if (recommendedValue) {
                ...
                if (valorAlternativo) {
                    const alternativeValue = document.querySelector('#rpaModal #alternativeValue');
                    if (alternativeValue) {
