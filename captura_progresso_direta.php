<?php
/**
 * CAPTURA DIRETA DO PROGRESSTRACKER NO PHP
 * Executa RPA e captura JSON completo com progresso
 */

class CapturaProgressoDireta {
    
    public function __construct() {
        echo "CAPTURA DIRETA DO PROGRESSTRACKER NO PHP\n";
        echo "========================================\n\n";
    }
    ...
    public function executarRPA() {
        echo "Executando RPA e capturando resultado...\n";
    ...
    public function executarCaptura() {
        try {
            ...
            echo "\nCAPTURA CONCLUIDA!\n";
            echo "ProgressTracker capturado diretamente no PHP OK\n";
...
if (basename(__FILE__) == basename($_SERVER["SCRIPT_NAME"])) {
    $captura = new CapturaProgressoDireta();
