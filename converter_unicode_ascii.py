...
Este script converte automaticamente caracteres Unicode problemáticos
para ASCII compreensível, permitindo que o RPA funcione no Windows.
"""
...
def carregar_substituicoes():
    """Carrega o mapeamento de substituições Unicode → ASCII"""
    ...
    substituicoes = {
        ...
        '‍': '[ZWJ]', '⃣': '[COMBINING]', '⚡': '[LIGHTNING]', '⛽': '[FUEL]',
        '✏️': '[PENCIL]', '❓': '[QUESTION]', '': '[REPLACEMENT]',
...
def main():
    ...
    print("🔧 CONVERSOR UNICODE → ASCII ATIVADO")
    print("=" * 50)
    print("✅ Resolvendo problemas de codificação no Windows")
    print("✅ Convertendo emojis para ASCII compreensível")
    print("✅ Mantendo acentos portugueses intactos")
