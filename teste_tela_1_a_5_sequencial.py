#!/usr/bin/env python3
"""
TESTE SEQUENCIAL: TELA 1 → TELA 2 → TELA 3 → TELA 4 → TELA 5
...
def main():
    """Função principal"""
    print("🎯 TESTE SEQUENCIAL: TELA 1 → TELA 2 → TELA 3 → TELA 4 → TELA 5")
    print("=" * 60)
    ...
    try:
        ...
        try:
            ...
            # Verificar se navegou para Tela 2
            try:
                elemento_tela2 = page.locator("text=Placa do veículo").first
                if elemento_tela2.is_visible():
                    print("✅ Navegação para Tela 2 confirmada")
                else:
                    print("⚠️ Navegação para Tela 2 não detectada, continuando...")
            except:
                print("⚠️ Verificação da Tela 2 falhou, continuando...")
        ...
        try:
            ...
            elemento_tela2 = page.locator("text=Placa do veículo").first
            if not elemento_tela2.is_visible():
                print("❌ ERRO: Não estamos na Tela 2 esperada!")
                return False
