<?php
/**
 * MONITOR DE PROGRESSO - VERSÃO FUNCIONAL
 * Executa RPA e captura resultado corretamente
 */

class MonitorProgressoFuncional {
    
    private $arquivo_config = "monitor_progress.json";
    
    public function __construct() {
        echo "🔍 MONITOR DE PROGRESSO - VERSÃO FUNCIONAL\n";
        echo "==========================================\n\n";
    }
    ...
    /**
     * Executar RPA usando exec() com buffer
     */
    public function executarRPA() {
        ...
        // Juntar todas as linhas do output
        $resultado_json = implode("\n", $output);
    ...
    public function analisarResultado($resultado_json) {
        ...
        if ($json_start !== false) {
            ...
            echo "❌ JSON não encontrado no output!\n";
            echo "📄 Conteúdo bruto:\n";
            echo $resultado_json . "\n";
            return;
        }
    ...
    public function limpar() {
        ...
        if (file_exists($this->arquivo_config)) {
            ...
            echo "🗑️ Removido: {$this->arquivo_config}\n";
        }
...
if (basename(__FILE__) == basename($_SERVER["SCRIPT_NAME"])) {
    $monitor = new MonitorProgressoFuncional();
