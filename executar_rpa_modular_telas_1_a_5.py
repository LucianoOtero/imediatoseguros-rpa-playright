...
def executar_rpa_playwright(parametros: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        ...
        with sync_playwright() as p:
            # FORÇAR HEADLESS=True para servidor
            ...
            # FINALIZAR EXECUÇÃO MODULAR - TELAS 1-5
            exibir_mensagem("\n" + "="*80)
            exibir_mensagem("🏁 EXECUÇÃO MODULAR CONCLUÍDA - TELAS 1-5")
            exibir_mensagem("="*80)
            
            # Finalizar progress tracker
            if progress_tracker:
                progress_tracker.finalizar('success', {"dados_tela_5": dados_carrossel} if 'dados_carrossel' in locals() else {})
