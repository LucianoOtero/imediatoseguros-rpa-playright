#!/usr/bin/env python3
"""
EXECUTAR RPA IMEDIATO PLAYWRIGHT - VERSÃO v3.7.0.1
...
AUTOR: Luciano Otero
DATA: 2025-09-09
VERSÃO: v3.7.0.1 (Seletor Específico Botão Carro)
STATUS: Implementação completa com Exception Handler + Compatibilidade Regional + Seletor Específico
"""
