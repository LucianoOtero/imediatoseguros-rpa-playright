...
class CommunicationManager:
    ...
    def create_session(self, session_data: Dict[str, Any]) -> str:
        ...
        # Notificar criação da sessão
        self.send_session_event(session_id, "session_created", session_data)
    ...
    def update_session(self, session_id: str, updates: Dict[str, Any]) -> bool:
        ...
        try:
            ...
            self.send_session_event(session_id, "session_updated", updates)
    ...
    def update_progress(self, session_id: str, progress_data: Dict[str, Any]) -> bool:
        ...
        try:
            ...
            websocket_manager.send_progress_update(session_id, progress_data)
    ...
    def send_session_event(self, session_id: str, event_type: str, data: Dict[str, Any]) -> bool:
    ...
    def send_error(self, session_id: str, error: str, details: Dict[str, Any] = None) -> bool:
        ...
        try:
            # Enviar via WebSocket
            websocket_manager.send_error(session_id, error, details)
    ...
    def delete_session(self, session_id: str) -> bool:
        ...
        try:
            ...
            # Notificar remoção
            self.send_session_event(session_id, "session_deleted", {})
