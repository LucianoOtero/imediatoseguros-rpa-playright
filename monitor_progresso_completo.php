<?php
/**
 * MONITOR PROGRESSTRACKER COMPLETO
 * Acompanha passo a passo desde o início
 */

class MonitorProgressoCompleto {
    ...
    public function __construct() {
        echo "MONITOR PROGRESSTRACKER COMPLETO\n";
        echo "================================\n\n";
    }
    ...
    public function executarMonitoramento() {
        try {
            ...
            echo "ProgressTracker monitorado passo a passo OK\n";
...
if (basename(__FILE__) == basename($_SERVER["SCRIPT_NAME"])) {
    $monitor = new MonitorProgressoCompleto();
