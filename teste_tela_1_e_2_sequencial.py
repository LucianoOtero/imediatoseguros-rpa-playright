#!/usr/bin/env python3
"""
TESTE SEQUENCIAL: TELA 1 → TELA 2
Executa Tela 1 (que já funciona) e depois Tela 2
"""
...
def main():
    """Função principal"""
    print("🎯 TESTE SEQUENCIAL: TELA 1 → TELA 2")
    print("=" * 45)
